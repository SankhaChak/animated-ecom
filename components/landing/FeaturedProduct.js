  ...
  return (
    <div className="col-span-6 grid grid-cols-1 md:grid-cols-8">
      <div className="md:col-span-2 order-2 md:order-1 relative z-40 flex flex-col justify-center">
        <h1 className="text-2xl md:text-4xl font-bold text-center md:text-left flex-1 md:flex md:items-center product-name">
          {name}
        </h1>
      ...
      <div className="md:col-span-4 relative order-1 md:order-2">
        ...
        <Link href={`/products/${id}`}>
          <a className="absolute top-1/2 left-1/2 transform -translate-x-1/2 md:left-1/4 md:translate-x-0 bg-slate-300 text-black p-4 rounded-full z-20 product-link origin-center">
